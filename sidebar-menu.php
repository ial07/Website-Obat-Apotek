  ...
  <ul class="sidebar-menu">
    ...
    if ($_GET["module"] == "obat_masuk") { ?>
      <li class="active treeview">
        <a href="javascript:void(0);">
          <i class="fa fa-file-text"></i> <span>Input</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
          <li class="active"><a href="?module=obat_masuk"><i class="fa fa-clone"></i> Obat Masuk </a></li>
          <li><a href="?module=obat_keluar"><i class="fa fa-clone"></i> Obat Keluar</a></li>
        </ul>
      </li>
    <?php
    }
    ...
    elseif ($_GET["module"] == "obat_keluar") { ?>
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="?module=obat_masuk"><i class="fa fa-clone"></i> Obat Masuk </a></li>
          <li class="active"><a href="?module=obat_keluar"><i class="fa fa-clone"></i> Obat Keluar </a></li>
        </ul>
      </li>
    <?php
    }
    ...
    if ($_GET["module"] == "lap_stok") { ?>
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Laporan Metode FIFO </a></li>
        </ul>
      </li>
    <?php
    }
    ...
    elseif ($_GET["module"] == "lap_obat_masuk") { ?>
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li class="active"><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Laporan Metode FIFO </a></li>
        </ul>
      </li>
    <?php
    }
