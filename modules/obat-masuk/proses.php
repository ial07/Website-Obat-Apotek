...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act'] == 'insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_obat_masuk(kode_transaksi,tanggal_masuk,kode_obat,jumlah_masuk,created_user) VALUES('$kode_transaksi','$tanggal_masuk','$kode_obat','$jumlah_masuk','$created_user')")
                or die('Ada kesalahan pada query insert : ' . mysqli_error($mysqli));

            mysqli_query($mysqli, "INSERT INTO is_fifo(kode_transaksi,tanggal,kode_obat,jumlah_masuk,stok,created_user) VALUES('$kode_transaksi','$tanggal_masuk','$kode_obat','$jumlah_masuk',$total_stok,'$created_user')")
                or die('Ada kesalahan pada query insert : ' . mysqli_error($mysqli));
